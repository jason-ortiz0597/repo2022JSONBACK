        ...
        <q-card flat bordered style="width: 500px; min-height: 100px">
            ...
            <q-card-section class="q-ma-none q-pb-none">
                <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
                    ...
                    <q-input filled v-model="description" label="Descripción del Tipo de Proveedores *"
    ...
    setup(props, { emit }) {
        ...
        return {
            ...
            myFunction() {
                ...
                $q.notify({
                    message: "Tipo de Proveedor Agregado",
                    color: "positive",
                    position: "top",
                    timeout: 2000,
                });
