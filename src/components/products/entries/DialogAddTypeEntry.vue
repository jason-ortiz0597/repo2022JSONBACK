        ...
        <q-card flat bordered style="width: 500px; min-height: 100px">
            ...
            <q-card-section class="q-ma-none q-pb-none">
                <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
                    <q-input filled v-model="name" label="Tipo de Entrada *" hint="Mínimo 3, Máximo 30 caracteres"
                        lazy-rules :rules="[
                          (val) => (val && val.length > 2) || 'Mínimo 3 caracteres',
                          (val) => val.length < 31 || 'Máximo 30 caracteres',
                        ]" />

                    <q-input filled v-model="description" label="Descripción del Tipo de Entrada *"
                    ...
                    <q-select filled v-model="status" label="Estado del Entrada *" :options="[
    ...
    setup(props, { emit }) {
        ...
        return {
            ...
            myFunction() {
                ...
                $q.notify({
                    message: "Tipo de Entrada Agregado",
                    color: "positive",
                    position: "top",
                    timeout: 2000,
                });
