                ...
                <div class="q-pa-md">
                    <div class="row q-col-gutter-x-md">
                        <div class="col-6 ">
                            ...
                            <q-input filled v-model="quantity" type="number" label="Cantidad" lazy-rules :rules="[
                              (val) => (val !== null && val !== '') || 'Ingrese una cantidad',
                              (val) => (val > 0 && val < 99999999) || 'Ingrese una cantidad válida',
                            ]" />
                        ...
                        <div class="col-6">
                            <q-input filled v-model="total" type="number" label="Total Stock" />
                        </div>

                        <div class="col-6">
                            <q-input filled v-model="dateEntries" type="date" hint="Fecha de Entrada" />
                        </div>
